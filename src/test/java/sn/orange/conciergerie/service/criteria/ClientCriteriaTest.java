...
class ClientCriteriaTest {
    ...
    private static void setAllFilters(ClientCriteria clientCriteria) {
        clientCriteria.id();
        clientCriteria.numero();
        clientCriteria.prenom();
        clientCriteria.nom();
        clientCriteria.email();
        clientCriteria.userId();
        clientCriteria.typeClientId();
        clientCriteria.segmentClientId();
    ...
    private static Condition<ClientCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getTypeClientId()) &&
                condition.apply(criteria.getSegmentClientId()) &&
    ...
    private static Condition<ClientCriteria> copyFiltersAre(ClientCriteria copy, BiFunction<Object, Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getTypeClientId(), copy.getTypeClientId()) &&
                condition.apply(criteria.getSegmentClientId(), copy.getSegmentClientId()) &&
