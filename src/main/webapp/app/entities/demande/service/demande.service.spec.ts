...
describe('Demande Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Demande', () => {
      ...
      service.create(demande).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Demande', () => {
      ...
      service.update(demande).subscribe(resp => (expectedResult = resp));
    ...
    describe('addDemandeToCollectionIfMissing', () => {
      it('should add a Demande to an empty array', () => {
        ...
        expect(expectedResult).toEqual([demande]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([demande, demande2]);
      });
    ...
    describe('compareDemande', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { id: 'db61c811-f5b6-4f5a-a362-3462da216ecd' };
        const entity2 = null;
      ...
      it('should return true if primaryKey matches', () => {
        const entity1 = { id: 'db61c811-f5b6-4f5a-a362-3462da216ecd' };
        const entity2 = { id: 'db61c811-f5b6-4f5a-a362-3462da216ecd' };
