...
import { sampleWithRequiredData } from '../code-promo.test-samples';
...
describe('CodePromo Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: CodePromo;
  let fixture: ComponentFixture<CodePromo>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CodePromo);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 'b727eb78-e176-4142-8685-21300126e80d' }], {
    ...
    expect(comp.codePromos()[0]).toEqual(expect.objectContaining({ id: 'b727eb78-e176-4142-8685-21300126e80d' }));
  });

  describe('trackId', () => {
    it('should forward to codePromoService', () => {
      const entity = { id: 'b727eb78-e176-4142-8685-21300126e80d' };
      vi.spyOn(service, 'getCodePromoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCodePromoIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.codePromosParams()).toMatchObject({ sort: ['id,desc'] });
  });
