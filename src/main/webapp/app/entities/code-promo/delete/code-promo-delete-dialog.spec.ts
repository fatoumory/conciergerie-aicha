...
import { CodePromoDeleteDialog } from './code-promo-delete-dialog';

describe('CodePromo Management Delete Component', () => {
  let comp: CodePromoDeleteDialog;
  let fixture: ComponentFixture<CodePromoDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CodePromoDeleteDialog);
