...
import { AffectationDemandeDeleteDialog } from './affectation-demande-delete-dialog';

describe('AffectationDemande Management Delete Component', () => {
  let comp: AffectationDemandeDeleteDialog;
  let fixture: ComponentFixture<AffectationDemandeDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AffectationDemandeDeleteDialog);
