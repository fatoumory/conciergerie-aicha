...
@Component({
  templateUrl: './affectation-demande-delete-dialog.html',
  imports: [TranslateDirective, FormsModule, FontAwesomeModule, AlertError],
})
export class AffectationDemandeDeleteDialog {
  affectationDemande?: IAffectationDemande;
  ...
  confirmDelete(id: string): void {
    this.affectationDemandeService.delete(id).subscribe(() => {
