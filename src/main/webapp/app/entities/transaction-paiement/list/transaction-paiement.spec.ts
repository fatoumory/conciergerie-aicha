...
import { sampleWithRequiredData } from '../transaction-paiement.test-samples';

import { TransactionPaiement } from './transaction-paiement';

vi.useFakeTimers();

describe('TransactionPaiement Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: TransactionPaiement;
  let fixture: ComponentFixture<TransactionPaiement>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TransactionPaiement);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '33f8355d-c755-4a93-9672-44338f6f0121' }], {
    ...
    expect(comp.transactionPaiements()[0]).toEqual(expect.objectContaining({ id: '33f8355d-c755-4a93-9672-44338f6f0121' }));
  });
  ...
  it('should cancel previous requests when loading a new page', async () => {
    ...
    req2.flush([{ id: '33f8355d-c755-4a93-9672-44338f6f0121' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vi.runAllTimersAsync();
  ...
  it('should not fail on resource error state', async () => {
    ...
    expect(comp.transactionPaiements()).toEqual([]);

    // WHEN - second load should still work
    comp.load();
    TestBed.tick();
    const successReq = httpMock.expectOne({ method: 'GET' });
    successReq.flush([{ id: '33f8355d-c755-4a93-9672-44338f6f0121' }], {
      headers: { link: '<http://localhost/api/foo?page=1&size=20>; rel="next"' },
    });
    await vi.runAllTimersAsync();
  ...
  describe('trackId', () => {
    it('should forward to transactionPaiementService', () => {
      const entity = { id: '33f8355d-c755-4a93-9672-44338f6f0121' };
      vi.spyOn(service, 'getTransactionPaiementIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTransactionPaiementIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.transactionPaiementsParams()).toMatchObject({ sort: ['id,desc'] });
  });
  ...
  it('should calculate the filter attribute', () => {
    ...
    // THEN
    expect(service.transactionPaiementsParams()).toMatchObject({ 'someId.in': ['dc4279ea-cfb9-11ec-9d64-0242ac120002'] });
  });
