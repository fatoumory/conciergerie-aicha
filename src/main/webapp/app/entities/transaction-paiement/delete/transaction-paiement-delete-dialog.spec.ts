...
import { TransactionPaiementDeleteDialog } from './transaction-paiement-delete-dialog';

describe('TransactionPaiement Management Delete Component', () => {
  let comp: TransactionPaiementDeleteDialog;
  let fixture: ComponentFixture<TransactionPaiementDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TransactionPaiementDeleteDialog);
