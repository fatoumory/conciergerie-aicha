...
import { PartenaireZoneDeleteDialog } from './partenaire-zone-delete-dialog';

describe('PartenaireZone Management Delete Component', () => {
  let comp: PartenaireZoneDeleteDialog;
  let fixture: ComponentFixture<PartenaireZoneDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PartenaireZoneDeleteDialog);
