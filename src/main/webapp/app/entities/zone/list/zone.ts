...
import { ZoneDeleteDialog } from '../delete/zone-delete-dialog';
...
export class Zone {
  ...
  readonly isLoading = this.zoneService.zonesResource.isLoading;
  ...
  constructor() {
    effect(() => {
      this.zones.set(this.fillComponentAttributesFromResponseBody([...this.zoneService.zones()]));
    });
    effect(() => {
  ...
  trackId = (item: IZone): string => this.zoneService.getZoneIdentifier(item);

  delete(zone: IZone): void {
    const modalRef = this.modalService.open(ZoneDeleteDialog, { size: 'lg', backdrop: 'static' });
  ...
  protected fillComponentAttributesFromResponseBody(data: IZone[]): IZone[] {
  ...
  protected queryBackend(): void {
    ...
    this.zoneService.zonesParams.set(queryObject);
  }
