...
import { sampleWithRequiredData } from '../zone.test-samples';
...
describe('Zone Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '876dfa56-710f-4774-ab70-e59edf28e4d6' }], {
    ...
    expect(comp.zones()[0]).toEqual(expect.objectContaining({ id: '876dfa56-710f-4774-ab70-e59edf28e4d6' }));
  });

  describe('trackId', () => {
    it('should forward to zoneService', () => {
      const entity = { id: '876dfa56-710f-4774-ab70-e59edf28e4d6' };
      vi.spyOn(service, 'getZoneIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.zonesParams()).toMatchObject({ sort: ['id,desc'] });
  });
