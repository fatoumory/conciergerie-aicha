...
import { sampleWithRequiredData } from '../profil.test-samples';
...
describe('Profil Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '56981eb1-c9ea-4f7a-a914-91454668ffa6' }], {
    ...
    expect(comp.profils()[0]).toEqual(expect.objectContaining({ id: '56981eb1-c9ea-4f7a-a914-91454668ffa6' }));
  });

  describe('trackId', () => {
    it('should forward to profilService', () => {
      const entity = { id: '56981eb1-c9ea-4f7a-a914-91454668ffa6' };
      vi.spyOn(service, 'getProfilIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.profilsParams()).toMatchObject({ sort: ['id,desc'] });
  });
