...
import { TypeDemandeDeleteDialog } from './type-demande-delete-dialog';

describe('TypeDemande Management Delete Component', () => {
  let comp: TypeDemandeDeleteDialog;
  let fixture: ComponentFixture<TypeDemandeDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TypeDemandeDeleteDialog);
