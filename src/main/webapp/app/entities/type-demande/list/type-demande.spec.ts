...
import { sampleWithRequiredData } from '../type-demande.test-samples';

import { TypeDemande } from './type-demande';

vi.useFakeTimers();

describe('TypeDemande Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: TypeDemande;
  let fixture: ComponentFixture<TypeDemande>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TypeDemande);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '3bce589b-05cc-4b45-95d3-6d0dcb5e23ee' }], {
    ...
    expect(comp.typeDemandes()[0]).toEqual(expect.objectContaining({ id: '3bce589b-05cc-4b45-95d3-6d0dcb5e23ee' }));
  });

  describe('trackId', () => {
    it('should forward to typeDemandeService', () => {
      const entity = { id: '3bce589b-05cc-4b45-95d3-6d0dcb5e23ee' };
      vi.spyOn(service, 'getTypeDemandeIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTypeDemandeIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.typeDemandesParams()).toMatchObject({ sort: ['id,desc'] });
  });
