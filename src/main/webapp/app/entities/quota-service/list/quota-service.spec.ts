...
import { sampleWithRequiredData } from '../quota-service.test-samples';
...
describe('QuotaService Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: QuotaService;
  let fixture: ComponentFixture<QuotaService>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(QuotaService);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 'daade9e5-0205-4f17-8182-5b2a4757eae2' }], {
    ...
    expect(comp.quotaServices()[0]).toEqual(expect.objectContaining({ id: 'daade9e5-0205-4f17-8182-5b2a4757eae2' }));
  });

  describe('trackId', () => {
    it('should forward to quotaServiceService', () => {
      const entity = { id: 'daade9e5-0205-4f17-8182-5b2a4757eae2' };
      vi.spyOn(service, 'getQuotaServiceIdentifier');
      const id = comp.trackId(entity);
      expect(service.getQuotaServiceIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.quotaServicesParams()).toMatchObject({ sort: ['id,desc'] });
  });
