...
import { QuotaServiceDeleteDialog } from './quota-service-delete-dialog';

describe('QuotaService Management Delete Component', () => {
  let comp: QuotaServiceDeleteDialog;
  let fixture: ComponentFixture<QuotaServiceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(QuotaServiceDeleteDialog);
