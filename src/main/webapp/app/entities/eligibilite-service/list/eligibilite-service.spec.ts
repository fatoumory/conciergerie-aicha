...
import { sampleWithRequiredData } from '../eligibilite-service.test-samples';
...
describe('EligibiliteService Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: EligibiliteService;
  let fixture: ComponentFixture<EligibiliteService>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EligibiliteService);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 'b71c6aa4-4ba4-4639-b209-31b0ecdb2f92' }], {
    ...
    expect(comp.eligibiliteServices()[0]).toEqual(expect.objectContaining({ id: 'b71c6aa4-4ba4-4639-b209-31b0ecdb2f92' }));
  });

  describe('trackId', () => {
    it('should forward to eligibiliteServiceService', () => {
      const entity = { id: 'b71c6aa4-4ba4-4639-b209-31b0ecdb2f92' };
      vi.spyOn(service, 'getEligibiliteServiceIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEligibiliteServiceIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.eligibiliteServicesParams()).toMatchObject({ sort: ['id,desc'] });
  });
