...
import { ServiceConciergerieDeleteDialog } from './service-conciergerie-delete-dialog';

describe('ServiceConciergerie Management Delete Component', () => {
  let comp: ServiceConciergerieDeleteDialog;
  let fixture: ComponentFixture<ServiceConciergerieDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ServiceConciergerieDeleteDialog);
