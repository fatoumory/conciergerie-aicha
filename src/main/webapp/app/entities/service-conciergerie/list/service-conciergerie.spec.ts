...
import { sampleWithRequiredData } from '../service-conciergerie.test-samples';

import { ServiceConciergerie } from './service-conciergerie';

vi.useFakeTimers();

describe('ServiceConciergerie Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: ServiceConciergerie;
  let fixture: ComponentFixture<ServiceConciergerie>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ServiceConciergerie);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 'f54d1854-fde0-462c-bb5b-1cd05107179d' }], {
    ...
    expect(comp.serviceConciergeries()[0]).toEqual(expect.objectContaining({ id: 'f54d1854-fde0-462c-bb5b-1cd05107179d' }));
  });

  describe('trackId', () => {
    it('should forward to serviceConciergerieService', () => {
      const entity = { id: 'f54d1854-fde0-462c-bb5b-1cd05107179d' };
      vi.spyOn(service, 'getServiceConciergerieIdentifier');
      const id = comp.trackId(entity);
      expect(service.getServiceConciergerieIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.serviceConciergeriesParams()).toMatchObject({ sort: ['id,desc'] });
  });
