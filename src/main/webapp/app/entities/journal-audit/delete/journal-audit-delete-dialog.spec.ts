...
import { JournalAuditDeleteDialog } from './journal-audit-delete-dialog';

describe('JournalAudit Management Delete Component', () => {
  let comp: JournalAuditDeleteDialog;
  let fixture: ComponentFixture<JournalAuditDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(JournalAuditDeleteDialog);
