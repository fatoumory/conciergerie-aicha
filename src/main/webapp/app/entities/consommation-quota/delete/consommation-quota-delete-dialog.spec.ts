...
import { ConsommationQuotaDeleteDialog } from './consommation-quota-delete-dialog';

describe('ConsommationQuota Management Delete Component', () => {
  let comp: ConsommationQuotaDeleteDialog;
  let fixture: ComponentFixture<ConsommationQuotaDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ConsommationQuotaDeleteDialog);
