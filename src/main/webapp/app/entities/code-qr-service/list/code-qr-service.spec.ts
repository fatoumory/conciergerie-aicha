...
import { sampleWithRequiredData } from '../code-qr-service.test-samples';
...
describe('CodeQrService Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: CodeQrService;
  let fixture: ComponentFixture<CodeQrService>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CodeQrService);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '22ef53f8-4fa3-48b7-9f16-be67fa41d8c0' }], {
    ...
    expect(comp.codeQrServices()[0]).toEqual(expect.objectContaining({ id: '22ef53f8-4fa3-48b7-9f16-be67fa41d8c0' }));
  });

  describe('trackId', () => {
    it('should forward to codeQrServiceService', () => {
      const entity = { id: '22ef53f8-4fa3-48b7-9f16-be67fa41d8c0' };
      vi.spyOn(service, 'getCodeQrServiceIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCodeQrServiceIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.codeQrServicesParams()).toMatchObject({ sort: ['id,desc'] });
  });
