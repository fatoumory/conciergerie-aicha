...
import { TypeServiceDeleteDialog } from './type-service-delete-dialog';

describe('TypeService Management Delete Component', () => {
  let comp: TypeServiceDeleteDialog;
  let fixture: ComponentFixture<TypeServiceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TypeServiceDeleteDialog);
