...
import { sampleWithRequiredData } from '../type-client.test-samples';
...
describe('TypeClient Management Component', () => {
  ...
  let comp: TypeClient;
  let fixture: ComponentFixture<TypeClient>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TypeClient);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 'd3edaf1a-b61b-49ca-beb4-167f25744ead' }], {
    ...
    expect(comp.typeClients()[0]).toEqual(expect.objectContaining({ id: 'd3edaf1a-b61b-49ca-beb4-167f25744ead' }));
  });

  describe('trackId', () => {
    it('should forward to typeClientService', () => {
      const entity = { id: 'd3edaf1a-b61b-49ca-beb4-167f25744ead' };
      vi.spyOn(service, 'getTypeClientIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTypeClientIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.typeClientsParams()).toMatchObject({ sort: ['id,desc'] });
  });
