...
import { TypeClientDeleteDialog } from './type-client-delete-dialog';

describe('TypeClient Management Delete Component', () => {
  let comp: TypeClientDeleteDialog;
  let fixture: ComponentFixture<TypeClientDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TypeClientDeleteDialog);
