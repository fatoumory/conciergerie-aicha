...
import { UtilisationCodeQrDeleteDialog } from './utilisation-code-qr-delete-dialog';

describe('UtilisationCodeQr Management Delete Component', () => {
  let comp: UtilisationCodeQrDeleteDialog;
  let fixture: ComponentFixture<UtilisationCodeQrDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(UtilisationCodeQrDeleteDialog);
