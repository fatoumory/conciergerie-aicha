...
import { sampleWithRequiredData } from '../compte-stock.test-samples';
import { CompteStockService } from '../service/compte-stock.service';

import { CompteStock } from './compte-stock';

vi.useFakeTimers();

describe('CompteStock Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: CompteStock;
  let fixture: ComponentFixture<CompteStock>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CompteStock);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '51dcb663-66e6-485f-ad6e-94371c61b67e' }], {
    ...
    expect(comp.compteStocks()[0]).toEqual(expect.objectContaining({ id: '51dcb663-66e6-485f-ad6e-94371c61b67e' }));
  });

  describe('trackId', () => {
    it('should forward to compteStockService', () => {
      const entity = { id: '51dcb663-66e6-485f-ad6e-94371c61b67e' };
      vi.spyOn(service, 'getCompteStockIdentifier');
      const id = comp.trackId(entity);
      expect(service.getCompteStockIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.compteStocksParams()).toMatchObject({ sort: ['id,desc'] });
  });
