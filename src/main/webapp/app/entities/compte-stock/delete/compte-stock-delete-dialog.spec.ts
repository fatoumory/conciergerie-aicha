...
import { CompteStockDeleteDialog } from './compte-stock-delete-dialog';

describe('CompteStock Management Delete Component', () => {
  let comp: CompteStockDeleteDialog;
  let fixture: ComponentFixture<CompteStockDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CompteStockDeleteDialog);
