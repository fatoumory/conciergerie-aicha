...
import { PartenaireDeleteDialog } from '../delete/partenaire-delete-dialog';
...
export class Partenaire {
  readonly partenaires = signal<IPartenaire[]>([]);
  ...
  readonly isLoading = this.partenaireService.partenairesResource.isLoading;
  ...
  constructor() {
    effect(() => {
      this.partenaires.set(this.fillComponentAttributesFromResponseBody([...this.partenaireService.partenaires()]));
    });
    effect(() => {
  ...
  trackId = (item: IPartenaire): string => this.partenaireService.getPartenaireIdentifier(item);

  delete(partenaire: IPartenaire): void {
    const modalRef = this.modalService.open(PartenaireDeleteDialog, { size: 'lg', backdrop: 'static' });
  ...
  protected fillComponentAttributesFromResponseBody(data: IPartenaire[]): IPartenaire[] {
  ...
  protected queryBackend(): void {
    ...
    this.partenaireService.partenairesParams.set(queryObject);
  }
