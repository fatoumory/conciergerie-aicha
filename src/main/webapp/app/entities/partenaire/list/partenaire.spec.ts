...
import { sampleWithRequiredData } from '../partenaire.test-samples';
...
describe('Partenaire Management Component', () => {
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: 'd330918e-c880-4b4f-a4ba-30a19287c322' }], {
    ...
    expect(comp.partenaires()[0]).toEqual(expect.objectContaining({ id: 'd330918e-c880-4b4f-a4ba-30a19287c322' }));
  });

  describe('trackId', () => {
    it('should forward to partenaireService', () => {
      const entity = { id: 'd330918e-c880-4b4f-a4ba-30a19287c322' };
      vi.spyOn(service, 'getPartenaireIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.partenairesParams()).toMatchObject({ sort: ['id,desc'] });
  });
