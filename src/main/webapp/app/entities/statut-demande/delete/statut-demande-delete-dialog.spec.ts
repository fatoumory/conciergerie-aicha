...
import { StatutDemandeDeleteDialog } from './statut-demande-delete-dialog';

describe('StatutDemande Management Delete Component', () => {
  let comp: StatutDemandeDeleteDialog;
  let fixture: ComponentFixture<StatutDemandeDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(StatutDemandeDeleteDialog);
