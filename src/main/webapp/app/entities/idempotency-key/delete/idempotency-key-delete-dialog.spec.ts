...
import { IdempotencyKeyDeleteDialog } from './idempotency-key-delete-dialog';

describe('IdempotencyKey Management Delete Component', () => {
  let comp: IdempotencyKeyDeleteDialog;
  let fixture: ComponentFixture<IdempotencyKeyDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(IdempotencyKeyDeleteDialog);
