...
import { SegmentClientDeleteDialog } from './segment-client-delete-dialog';

describe('SegmentClient Management Delete Component', () => {
  let comp: SegmentClientDeleteDialog;
  let fixture: ComponentFixture<SegmentClientDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SegmentClientDeleteDialog);
