...
import { sampleWithRequiredData } from '../segment-client.test-samples';
...
describe('SegmentClient Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: SegmentClient;
  let fixture: ComponentFixture<SegmentClient>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SegmentClient);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '6ca2c935-8cf0-4d27-b38f-08fa9e7b9333' }], {
    ...
    expect(comp.segmentClients()[0]).toEqual(expect.objectContaining({ id: '6ca2c935-8cf0-4d27-b38f-08fa9e7b9333' }));
  });

  describe('trackId', () => {
    it('should forward to segmentClientService', () => {
      const entity = { id: '6ca2c935-8cf0-4d27-b38f-08fa9e7b9333' };
      vi.spyOn(service, 'getSegmentClientIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSegmentClientIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.segmentClientsParams()).toMatchObject({ sort: ['id,desc'] });
  });
