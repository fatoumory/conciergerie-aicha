...
@Component({
  templateUrl: './couverture-partenaire-delete-dialog.html',
  imports: [TranslateDirective, FormsModule, FontAwesomeModule, AlertError],
})
export class CouverturePartenaireDeleteDialog {
  couverturePartenaire?: ICouverturePartenaire;
  ...
  confirmDelete(id: string): void {
    this.couverturePartenaireService.delete(id).subscribe(() => {
