...
import { sampleWithRequiredData } from '../quota-detail.test-samples';
...
describe('QuotaDetail Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: QuotaDetail;
  let fixture: ComponentFixture<QuotaDetail>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(QuotaDetail);
  ...
  it('should call load all on init', async () => {
    ...
    req.flush([{ id: '31462f49-bad8-4eb5-a5b5-d2493b87b976' }], {
    ...
    expect(comp.quotaDetails()[0]).toEqual(expect.objectContaining({ id: '31462f49-bad8-4eb5-a5b5-d2493b87b976' }));
  });

  describe('trackId', () => {
    it('should forward to quotaDetailService', () => {
      const entity = { id: '31462f49-bad8-4eb5-a5b5-d2493b87b976' };
      vi.spyOn(service, 'getQuotaDetailIdentifier');
      const id = comp.trackId(entity);
      expect(service.getQuotaDetailIdentifier).toHaveBeenCalledWith(entity);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.quotaDetailsParams()).toMatchObject({ sort: ['id,desc'] });
  });
