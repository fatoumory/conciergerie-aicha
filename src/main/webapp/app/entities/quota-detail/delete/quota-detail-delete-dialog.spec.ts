...
import { QuotaDetailDeleteDialog } from './quota-detail-delete-dialog';

describe('QuotaDetail Management Delete Component', () => {
  let comp: QuotaDetailDeleteDialog;
  let fixture: ComponentFixture<QuotaDetailDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(QuotaDetailDeleteDialog);
